...
public class BinaryTreeZigzagLevelOrderTraversal {
    ...
    public static void main(String[] args) {
        ...
        for (int t = 0; t <  tests ; t++) {
            ...
            TreeNode root = new BinaryTreeZigzagLevelOrderTraversal().makeTreeFromEdges(parent, edges);

            List<List<Long>> result = new Solution().zigzagLevelOrder(root);
            for (List<Long> i : result) {
                for (Long j : i) {
                    System.out.print(  j + " ");
                }
                System.out.println();
